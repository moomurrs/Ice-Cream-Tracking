...
<main class="container">
    <div class="card border-primary mb-4">
        ...
        <div class="card-body">
            ...
            <p class="card-text fs-3">Here at <span class="fw-bold">Jojo's</span> <span
                    class="fst-italic">Bizzare</span> Ice Cream shop 🍦, we serve a range of strange and bizzare flavors
                to whet your curiosity! 😱
                Ever read Ripley's <span class="fst-italic">Believe or Not!&#8482;</span> and wasn't grossed out? Do you
                like the random nature of Jelly Beans&#8482;? Come and try the horrors with your taste-buds! 😎</p>
        </div>
    </div>
        ...
        <div class="col">
            <div class="card border-danger mb-4 mb-md-5">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text fs-3">
                        We'd love to get in touch! DM for us catering events, ill-fated flavor suggestions, and other
                        questions. See our other socials here.
                    </p>
                </div>
            </div>
        </div>
